...
create or replace function inserir_prato_generico(tabela TEXT, campo_um varchar,
                                                  campo_dois varchar, campo_tres double precision, campo_quatro int)
  returns void as
$inserir_prato_generico$
declare

begin
  if tabela = 'prato_principal' then
    if campo_um = '' or campo_dois = '' or campo_tres = '' or campo_quatro = '' then
    ...
    insert into prato_principal
    values (cast(campo_um as varchar), cast(campo_dois as varchar), cast(campo_tres as double precision),
            cast(campo_quatro as int));
--    insert into prato_principal values (campo_um, campo_dois, campo_tres, campo_quatro);
  end if;
  if tabela = 'acompanhamento' then
    ...
    insert into prato_principal
    values (default, cast(campo_um as varchar), cast(campo_dois as bool), cast(campo_tres as double precision),
            cast(campo_quatro as int));
  end if;
...
----			else
----			
----				insert into prato_principal values (cast(campo_um as varchar),cast(campo_dois as varchar),cast(campo_tres as float),cast(campo_quatro as int));
--				insert into prato_principal values (campo_um,campo_dois,campo_tres,campo_quatro);			
--		end if;	
--		if tabela = 'acompanhamento' then
--			if campo_um = '' or campo_dois = '' or campo_tres = '' or campo_quatro = ''  then
